 ...
 */
package com.camrin.shopping.inventoryproductcategory.view;

/**
 *
 * @author jndjk
 */
public class InventoryProductCategoryView {
    ...
    public InventoryProductCategoryView() {
    }

    public InventoryProductCategoryView(String inventory_product_category_id, String inventory_product_category_name, String inventory_product_category_description, String inventory_product_category_deleted, String inventory_product_category_updated) {
